...
class UserRepositoryTest {
    ...
    @Test
     void addUser_AddsUser_Success() throws SQLException {
    ...
    void deleteUser_Returns_OneAffectedRow() throws SQLException, UserNotFoundException {
        ...
        when(mockConnection.prepareStatement(UserRepository.DELETE_ROLE)).thenReturn(mockPreparedStatement);
        when(mockPreparedStatement.executeUpdate()).thenReturn(1);

        when(mockConnection.prepareStatement(UserRepository.DELETE_ORDER)).thenReturn(mockPreparedStatement);
        when(mockPreparedStatement.executeUpdate()).thenReturn(1);

        when(mockConnection.prepareStatement(UserRepository.DELETE_USER)).thenReturn(mockPreparedStatement);
        when(mockPreparedStatement.executeUpdate()).thenReturn(1);
